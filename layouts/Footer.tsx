      ...
      <section className="footer-wrapp container">
              ...
              .map(({ title, path, link }, idx) => (
                <li key={idx}>
                  <Link href={path} as={link}>
                    <a className={"footer-menu__item"}>{title}</a>
                  </Link>
                </li>
              ))}
          </ul>
        ...
        <div className="social">
          <div className="social-icons">
            <a
              href="https://www.facebook.com/ooomikprom/?modal=admin_todo_tour"
              target="blank"
            >
              <img
            ...
            <a
              href="https://www.youtube.com/channel/UCiCufEUCSmAVxjC9bfaCLRQ"
              target="blank"
            >
              <img
